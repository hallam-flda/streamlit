...
st.set_page_config(page_title="European Roulette", page_icon="📈")

st.sidebar.header("European Roulette Demo")
...
for _ in range(num_simulations):
    _, _, spins = european_roulette(10000, starting_balance, bet_size = bet_per_spin, betting = "colours")
